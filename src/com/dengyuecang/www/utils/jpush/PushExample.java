...
public class PushExample {
    ...
    protected static final String APP_KEY ="fc6f9ccfa622ca4e99c64e7d";
    protected static final String MASTER_SECRET = "636e2bdee8510bf8a72004e0";
...
//        testSendPushesWithMultiCallback();
    ...
    public static void testSendPushesWithMultiCallback() {
        ...
        URI uri = null;
        try {
            uri = new URI(host + ClientConfig.getInstance().get(ClientConfig.PUSH_PATH));
    ...
    private static class MyThread extends Thread {
        ...
        public void run() {
            ...
            try {
                String host = (String) ClientConfig.getInstance().get(ClientConfig.PUSH_HOST_NAME);
                URI uri = new URI(host + ClientConfig.getInstance().get(ClientConfig.PUSH_PATH));
                PushPayload payload = PushPayload.alertAll("test");
                System.out.println(payload.toString());
...
//            jpushClient.close();
	...
	public static PushPayload buildPushObject_all_all_alert() {
	    ...
	    return PushPayload.newBuilder()
                ...
                .setMessage(Message.content("api 测试"))
    ...
    public static PushPayload buildPushObject_all_alias_alert() {
        return PushPayload.newBuilder()
                .setPlatform(Platform.all())
                .setAudience(Audience.alias("18500902882"))
                .setNotification(Notification.alert("测试一下"))
                .setMessage(Message.content("api 测试"))
